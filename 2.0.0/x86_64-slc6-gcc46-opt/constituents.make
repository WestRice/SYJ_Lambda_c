...
#cmt_local_tagfile = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile = $(bin)$(SYJ_Lambda_c_tag).make
...
cmt_local_setup_SYJ_Lambda_c = $(bin)setup_SYJ_Lambda_c$$$$.make
...
SYJ_Lambda_c_extratags = -tag_add=target_SYJ_Lambda_c

#$(cmt_local_tagfile_SYJ_Lambda_c) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_SYJ_Lambda_c) ::
else
$(cmt_local_tagfile_SYJ_Lambda_c) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_SYJ_Lambda_c); then /bin/rm -f $(cmt_local_tagfile_SYJ_Lambda_c); fi ; \
	  $(cmtexe) -tag=$(tags) $(SYJ_Lambda_c_extratags) build tag_makefile >>$(cmt_local_tagfile_SYJ_Lambda_c)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_SYJ_Lambda_c)"; \
	  test ! -f $(cmt_local_setup_SYJ_Lambda_c) || \rm -f $(cmt_local_setup_SYJ_Lambda_c); \
	  trap '\rm -f $(cmt_local_setup_SYJ_Lambda_c)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(SYJ_Lambda_c_extratags) show setup >$(cmt_local_setup_SYJ_Lambda_c) && \
	  if [ -f $(cmt_final_setup_SYJ_Lambda_c) ] && \
	    \cmp -s $(cmt_final_setup_SYJ_Lambda_c) $(cmt_local_setup_SYJ_Lambda_c); then \
	    \rm $(cmt_local_setup_SYJ_Lambda_c); else \
	    \mv -f $(cmt_local_setup_SYJ_Lambda_c) $(cmt_final_setup_SYJ_Lambda_c); fi
...
not_SYJ_Lambda_c_dependencies = { n=0; for p in $?; do m=0; for d in $(SYJ_Lambda_c_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
SYJ_Lambda_cdirs :
	@if test ! -d $(bin)SYJ_Lambda_c; then $(mkdir) -p $(bin)SYJ_Lambda_c; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)SYJ_Lambda_c
else
SYJ_Lambda_cdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)SYJ_Lambda_c
#
#$(cmt_local_SYJ_Lambda_c_makefile) :: $(SYJ_Lambda_c_dependencies) $(cmt_local_tagfile_SYJ_Lambda_c) build_library_links dirs SYJ_Lambda_cdirs
#else
#$(cmt_local_SYJ_Lambda_c_makefile) :: $(SYJ_Lambda_c_dependencies) $(cmt_local_tagfile_SYJ_Lambda_c) build_library_links dirs
#endif
#else
#$(cmt_local_SYJ_Lambda_c_makefile) :: $(cmt_local_tagfile_SYJ_Lambda_c)
#endif

ifdef cmt_SYJ_Lambda_c_has_target_tag

ifndef QUICK
$(cmt_local_SYJ_Lambda_c_makefile) : $(SYJ_Lambda_c_dependencies) build_library_links
	$(echo) "(constituents.make) Building SYJ_Lambda_c.make"; \
	  $(cmtexe) -tag=$(tags) $(SYJ_Lambda_c_extratags) build constituent_config -out=$(cmt_local_SYJ_Lambda_c_makefile) SYJ_Lambda_c
else
$(cmt_local_SYJ_Lambda_c_makefile) : $(SYJ_Lambda_c_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SYJ_Lambda_c) ] || \
	  [ ! -f $(cmt_final_setup_SYJ_Lambda_c) ] || \
	  $(not_SYJ_Lambda_c_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building SYJ_Lambda_c.make"; \
	  $(cmtexe) -tag=$(tags) $(SYJ_Lambda_c_extratags) build constituent_config -out=$(cmt_local_SYJ_Lambda_c_makefile) SYJ_Lambda_c; \
	  fi
endif
...
$(cmt_local_SYJ_Lambda_c_makefile) : $(SYJ_Lambda_c_dependencies) build_library_links
	$(echo) "(constituents.make) Building SYJ_Lambda_c.make"; \
	  $(cmtexe) -f=$(bin)SYJ_Lambda_c.in -tag=$(tags) $(SYJ_Lambda_c_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_SYJ_Lambda_c_makefile) SYJ_Lambda_c
else
$(cmt_local_SYJ_Lambda_c_makefile) : $(SYJ_Lambda_c_dependencies) $(cmt_build_library_linksstamp) $(bin)SYJ_Lambda_c.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_SYJ_Lambda_c) ] || \
	  [ ! -f $(cmt_final_setup_SYJ_Lambda_c) ] || \
	  $(not_SYJ_Lambda_c_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(SYJ_Lambda_c_extratags) build constituent_makefile -out=$(cmt_local_SYJ_Lambda_c_makefile) SYJ_Lambda_c

SYJ_Lambda_c :: $(SYJ_Lambda_c_dependencies) $(cmt_local_SYJ_Lambda_c_makefile) dirs SYJ_Lambda_cdirs
	$(echo) "(constituents.make) Starting SYJ_Lambda_c"
	@if test -f $(cmt_local_SYJ_Lambda_c_makefile); then \
	  $(MAKE) -f $(cmt_local_SYJ_Lambda_c_makefile) SYJ_Lambda_c; \
	  fi
#	@$(MAKE) -f $(cmt_local_SYJ_Lambda_c_makefile) SYJ_Lambda_c
	$(echo) "(constituents.make) SYJ_Lambda_c done"

clean :: SYJ_Lambda_cclean

SYJ_Lambda_cclean :: $(SYJ_Lambda_cclean_dependencies) ##$(cmt_local_SYJ_Lambda_c_makefile)
	$(echo) "(constituents.make) Starting SYJ_Lambda_cclean"
	@-if test -f $(cmt_local_SYJ_Lambda_c_makefile); then \
	  $(MAKE) -f $(cmt_local_SYJ_Lambda_c_makefile) SYJ_Lambda_cclean; \
	fi
	$(echo) "(constituents.make) SYJ_Lambda_cclean done"
#	@-$(MAKE) -f $(cmt_local_SYJ_Lambda_c_makefile) SYJ_Lambda_cclean

##	  /bin/rm -f $(cmt_local_SYJ_Lambda_c_makefile) $(bin)SYJ_Lambda_c_dependencies.make

install :: SYJ_Lambda_cinstall

SYJ_Lambda_cinstall :: $(SYJ_Lambda_c_dependencies) $(cmt_local_SYJ_Lambda_c_makefile)
	$(echo) "(constituents.make) Starting install SYJ_Lambda_c"
	@-$(MAKE) -f $(cmt_local_SYJ_Lambda_c_makefile) install
	$(echo) "(constituents.make) install SYJ_Lambda_c done"

uninstall : SYJ_Lambda_cuninstall

$(foreach d,$(SYJ_Lambda_c_dependencies),$(eval $(d)uninstall_dependencies += SYJ_Lambda_cuninstall))

SYJ_Lambda_cuninstall : $(SYJ_Lambda_cuninstall_dependencies) ##$(cmt_local_SYJ_Lambda_c_makefile)
	$(echo) "(constituents.make) Starting uninstall SYJ_Lambda_c"
	@if test -f $(cmt_local_SYJ_Lambda_c_makefile); then \
	  $(MAKE) -f $(cmt_local_SYJ_Lambda_c_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_SYJ_Lambda_c_makefile) uninstall
	$(echo) "(constituents.make) uninstall SYJ_Lambda_c done"

remove_library_links :: SYJ_Lambda_cuninstall
...
#cmt_local_tagfile_config = $(SYJ_Lambda_c_tag)_config.make
cmt_local_tagfile_config = $(bin)$(SYJ_Lambda_c_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)SYJ_Lambda_c_configsetup.make
...
#cmt_local_tagfile_config = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_config = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)SYJ_Lambda_csetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(SYJ_Lambda_c_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(SYJ_Lambda_c_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)SYJ_Lambda_c_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_install_includes = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)SYJ_Lambda_csetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(SYJ_Lambda_c_tag)_make.make
cmt_local_tagfile_make = $(bin)$(SYJ_Lambda_c_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)SYJ_Lambda_c_makesetup.make
...
#cmt_local_tagfile_make = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_make = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)SYJ_Lambda_csetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(SYJ_Lambda_c_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(SYJ_Lambda_c_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)SYJ_Lambda_c_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)SYJ_Lambda_csetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(SYJ_Lambda_c_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(SYJ_Lambda_c_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)SYJ_Lambda_c_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)SYJ_Lambda_csetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(SYJ_Lambda_c_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(SYJ_Lambda_c_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)SYJ_Lambda_c_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)SYJ_Lambda_csetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(SYJ_Lambda_c_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(SYJ_Lambda_c_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)SYJ_Lambda_c_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)SYJ_Lambda_csetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(SYJ_Lambda_c_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(SYJ_Lambda_c_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)SYJ_Lambda_c_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_TestProject = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)SYJ_Lambda_csetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(SYJ_Lambda_c_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(SYJ_Lambda_c_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)SYJ_Lambda_c_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)SYJ_Lambda_csetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(SYJ_Lambda_c_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(SYJ_Lambda_c_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)SYJ_Lambda_c_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)SYJ_Lambda_csetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(SYJ_Lambda_c_tag)_EventNavigator_check_install_runtime.make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(SYJ_Lambda_c_tag)_EventNavigator_check_install_runtime.make
...
#cmt_final_setup_EventNavigator_check_install_runtime = $(bin)SYJ_Lambda_c_EventNavigator_check_install_runtimesetup.make
...
#cmt_local_tagfile_EventNavigator_check_install_runtime = $(SYJ_Lambda_c_tag).make
cmt_local_tagfile_EventNavigator_check_install_runtime = $(bin)$(SYJ_Lambda_c_tag).make
cmt_final_setup_EventNavigator_check_install_runtime = $(bin)setup.make
#cmt_final_setup_EventNavigator_check_install_runtime = $(bin)SYJ_Lambda_csetup.make
cmt_local_EventNavigator_check_install_runtime_makefile = $(bin)EventNavigator_check_install_runtime.make
