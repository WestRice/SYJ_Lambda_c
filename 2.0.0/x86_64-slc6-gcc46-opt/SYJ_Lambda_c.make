...
#
#   Generated Wed Oct 24 15:25:29 2018  by suyj
#
#====================================
...
$(SYJ_Lambda_clib) :: $(bin)Sigma0PionPi0.o $(bin)Sigma0PipPipPim.o $(bin)Sigma0PionEta.o $(bin)Entries.o $(bin)Load.o
	$(lib_echo) library
	$(lib_silent) cd $(bin); \
	  $(ar) $(SYJ_Lambda_clib) $?
...
SYJ_Lambda_cclean ::
	...
	$(cleanup_silent) cd $(bin); /bin/rm -f $(bin)Sigma0PionPi0.o $(bin)Sigma0PipPipPim.o $(bin)Sigma0PionEta.o $(bin)Entries.o $(bin)Load.o
...
ifneq ($(MAKECMDGOALS),SYJ_Lambda_cclean)
ifneq ($(MAKECMDGOALS),uninstall)
-include $(bin)$(binobj)Sigma0PipPipPim.d

$(bin)$(binobj)Sigma0PipPipPim.d :

$(bin)$(binobj)Sigma0PipPipPim.o : $(cmt_final_setup_SYJ_Lambda_c)

$(bin)$(binobj)Sigma0PipPipPim.o : $(src)Sigma0PipPipPim.cxx
	$(cpp_echo) $(src)Sigma0PipPipPim.cxx
	$(cpp_silent) $(cppcomp) -MMD -MP -MF $*.d -MQ $@ -o $@ $(use_pp_cppflags) $(SYJ_Lambda_c_pp_cppflags) $(lib_SYJ_Lambda_c_pp_cppflags) $(Sigma0PipPipPim_pp_cppflags) $(use_cppflags) $(SYJ_Lambda_c_cppflags) $(lib_SYJ_Lambda_c_cppflags) $(Sigma0PipPipPim_cppflags) $(Sigma0PipPipPim_cxx_cppflags)  $(src)Sigma0PipPipPim.cxx
endif
endif

else
$(bin)SYJ_Lambda_c_dependencies.make : $(Sigma0PipPipPim_cxx_dependencies)

$(bin)SYJ_Lambda_c_dependencies.make : $(src)Sigma0PipPipPim.cxx

$(bin)$(binobj)Sigma0PipPipPim.o : $(Sigma0PipPipPim_cxx_dependencies)
	$(cpp_echo) $(src)Sigma0PipPipPim.cxx
	$(cpp_silent) $(cppcomp) -o $@ $(use_pp_cppflags) $(SYJ_Lambda_c_pp_cppflags) $(lib_SYJ_Lambda_c_pp_cppflags) $(Sigma0PipPipPim_pp_cppflags) $(use_cppflags) $(SYJ_Lambda_c_cppflags) $(lib_SYJ_Lambda_c_cppflags) $(Sigma0PipPipPim_cppflags) $(Sigma0PipPipPim_cxx_cppflags)  $(src)Sigma0PipPipPim.cxx
