#ifndef Sigma0PionPi0_Header
#define Sigma0PionPi0_Header
...
class Sigma0PionPi0:public Algorithm {
  public:
    Sigma0PionPi0(const std::string& name, ISvcLocator* pSvcLocator);
    ~Sigma0PionPi0();
