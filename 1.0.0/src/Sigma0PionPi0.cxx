...
void Sigma0PionPi0::addItem(int idx)
{
	StatusCode status;
...
bool Sigma0PionPi0::isGoodShower(EvtRecTrack* trk){
...
bool Sigma0PionPi0::isGoodSigma0(WTrackParameter *lmd,RecEmcShower *gammaShr,double& sigma0_mass,HepLorentzVector& p4_sigma0,double& sigma0_chis,HepLorentzVector& p4_sigma0_1c){
