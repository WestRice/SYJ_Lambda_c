...
${CMTROOT}/mgr/cmt cleanup -csh -pack=SYJ_Lambda_c -version=1.0.0 -path=/workfs/bes/suyj/BES3_WorkArea/7.0.3  $* >${cmtSYJ_Lambda_ctempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/mgr/cmt cleanup -csh -pack=SYJ_Lambda_c -version=1.0.0 -path=/workfs/bes/suyj/BES3_WorkArea/7.0.3  $* >${cmtSYJ_Lambda_ctempfile}"
